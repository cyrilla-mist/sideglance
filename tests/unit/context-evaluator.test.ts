...
const analysis: ContextAnalysis = {
  ...
  signals: [{ phrase: 'fearless behavior 💀', signalType: 'irony', explanation: 'The emoji undercuts the praise.' }],
...
describe('ContextEvaluator', () => {
  ...
  it('reports tone mismatch and forbidden claims deterministically', () => {
    const result = new ContextEvaluator().evaluate({ id: 'bad', category: 'social_tone', input: 'x', expected: { tone: ['sincere'], forbiddenClaims: ['speaker is angry'] } }, { ...analysis, tone: ['playful'], socialImplication: 'The speaker is angry' });
